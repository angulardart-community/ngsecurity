...
void main() {
  ...
  test('should escape unsafe attributes', () async {
    ...
    await testFixture.update((component) {
      var c = component as UnsafeAttributeComponent;
      c.href = unsafeUrl;
    });
  ...
  test('should escape unsafe styles', () async {
    ...
    await testFixture.update((component) {
      var c = component as UnsafeStyleComponent;
      c.backgroundStyle = 'url(javascript:evil())';
    });
  ...
  test('should escape unsafe HTML', () async {
    ...
    await testFixture.update((component) {
      var c = component as UnsafeHtmlComponent;
